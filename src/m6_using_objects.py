...
def lines():
    ...
    -- Waits for the user to press the mouse, then closes the window.
    """
    line1Start = rg.Point(0,0)
    line1End = rg.Point(200, 170)
    line2Start = rg.Point(500, 300)
    line2End = rg.Point(300, 130)
